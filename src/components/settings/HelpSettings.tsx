...
const MockProviderSelectionAnim = () => {
    ...
    const options = [
        { id: 'local-whisper', label: 'Local Whisper', badge: '', recommended: true, desc: 'Privacy-first: runs on your device', color: 'green', icon: <Cpu size={14} /> },
...
const SetupGuide = () => {
    ...
    const steps = [
        ...
        {
            title: 'Set Up Audio',
            desc: 'Open Settings → Audio and select Local Whisper, or paste a Deepgram, Groq, OpenAI, or Google key.',
        },
        {
                        ...
                        <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                ...
                                <div className="p-4 rounded-xl border bg-accent-primary/5 border-border-subtle">
                                    <h4 className="font-semibold text-sm mb-2 text-text-primary flex items-center gap-2">
                                        <CheckCircle2 className="w-4 h-4 text-accent-primary" /> Local Setup
                                    </h4>
                                    <p className="text-[11px] text-text-secondary mb-2">
                                        Profile Intelligence runs as part of the local app experience.
                                    </p>
                                    <ol className="text-[11px] text-text-secondary space-y-1 list-decimal pl-4 mb-0">
                                        ...
                                        <li>Add a JD or custom notes when you want more focused answers.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                                    ...
                                    <ul className="text-[11px] text-text-secondary space-y-1 list-disc pl-4">
                                        ...
                                        <li>All built-in and custom modes are available locally</li>
                                    </ul>
                                </div>
                                <div className="p-4 rounded-xl border bg-bg-item-surface border-border-subtle">
                        ...
                        <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-xl">
                            <h4 className="text-[13px] font-semibold text-indigo-400 flex items-center gap-2 mb-1">
                                <Star size={14} /> Included
                            </h4>
                            <p className="text-[11px] text-text-secondary leading-relaxed mb-0">
                                All seven modes are available — pick one that matches your conversation (general, sales, recruiting, team meeting, looking for work, technical interview, lecture).
                            </p>
                        </div>
                    </div>
                </AccordionSection>
