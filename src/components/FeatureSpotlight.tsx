...
interface FeatureSlide {
    ...
    headline: string;
    subtitle: string;
    type?: 'feature' | 'support' | 'highlight';
    actionLabel?: string;
    url?: string;
    eyebrow?: string;
    bullets?: string[];
...
export const FeatureSpotlight: React.FC = () => {
    ...
    const isHighlight = currentFeature.type === 'highlight';
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 w-full h-full text-center">
                ...
                {/* Ambient Glow for Highlight Slide */}
                <AnimatePresence>
                            ...
                            >
                                ...
                                <h2
                                    ...
                                    style={{
                                        ...
                                        fontSize: (isHighlight || isSupport) ? '30px' : '26px',
                                        fontWeight: 500,
                                        lineHeight: 1.1,
                                        color: (isHighlight || isSupport) ? '#E6C46A' : '#ffffff',
                                        textShadow: (isHighlight || isSupport) ? '0px 1px 1px rgba(0, 0, 0, 0.1)' : 'none',
                                    }}
                                >
                                ...
                                <p
                                    ...
                                    style={{
                                        fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text"',
                                        fontSize: (isHighlight || isSupport) ? '16px' : '15px',
                                        fontWeight: 400,
                                        lineHeight: 1.4,
                                        color: '#F5F7FA',
                                        opacity: 0.9,
                                ...
                                {currentFeature.footer && (
                                    <div className="w-full text-center pointer-events-none mt-2 translate-y-5">
                                        <p
                                            ...
                                            style={{
                                                fontSize: (isHighlight || isSupport) ? '13px' : '15px',
                                                color: '#F5F7FA'
                                            }}
                                        >
                                            {currentFeature.footer}
