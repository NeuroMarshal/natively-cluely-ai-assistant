...
Natively runs as a local-first open-source desktop app. Bring your own cloud keys when you want them, or keep the stack fully local with Ollama and Local Whisper.

The former gated desktop capabilities are available in the app without a plan check:

| Feature                                             | Local open-source build |
| :-------------------------------------------------- | :---------------------- |
| **Bring Your Own Key (BYOK) Models**                | ✅ Available            |
| **Local AI Support (Ollama)**                       | ✅ Available            |
| **Local Whisper STT (On-Device)**                   | ✅ Available            |
| **Real-Time Speech-to-Text (<500ms)**               | ✅ Available            |
| **Multi-Key API Pools & Key Rotation**              | ✅ Available            |
| **Profile Intelligence Router (v2)**                | ✅ Available            |
| **Eager Code UI Expansion**                         | ✅ Available            |
| **Live Follow-Up Resolver**                         | ✅ Available            |
| **Real-Time Latency Tracing**                       | ✅ Available            |
| **Two New Meeting UI Styles (Liquid Glass/Modern)** | ✅ Available            |
| **Live Contextual Assistant**                       | ✅ Available            |
| **Screenshot & Slide OCR Analysis**                 | ✅ Available            |
| **Undetectable & Stealth Modes**                    | ✅ Available            |
| **Meeting Dashboard & Offline RAG History**         | ✅ Available            |
| **Job Description (JD) & Resume Context Awareness** | ✅ Available            |
| **Company Research & Dossiers**                     | ✅ Available with BYOK Tavily, otherwise LLM/local context fallback |
| **Live Salary & Offer Negotiation Copilot**         | ✅ Available            |
| **Custom Persona Modes (Sales, Tech, etc.)**        | ✅ Available            |
| **Custom Context & Notes**                          | ✅ Available            |
| **Reference Files (PDF/DOCX/TXT upload)**           | ✅ Available            |
| **Phone Link Companion App**                        | ✅ Available when configured |
| **Auto-Calendar & Task Sync**                       | ✅ Available when configured |
| **Speaker Diarization**                             | ✅ Available when supported by the selected STT provider |
...
- [Local Feature Stack](#local-feature-stack)
...
This repository is a modified fork. See [FORK_NOTICE.md](FORK_NOTICE.md) and
[NOTICE](NOTICE) for the modification record, attribution and redistribution
notes.

If you distribute binaries or installers, provide the corresponding source for
the exact version you ship. If you run a modified version that users interact
with over a network, AGPL-3.0 section 13 requires offering those users the
corresponding source code.

This local fork removes payment, trial, quota and upgrade gates from the desktop
app. Former gated desktop features are available as local AGPL-licensed source
in this repository.
